...
function AS_Button_3469f54f8607452283347923bd1d73d7(eventobject) {
    showMenu();
}
function AS_Button_3f06f6818d7c4d7c94d0bcc83438dc1a(eventobject) {
    frmRegisterKA.show();
}
function AS_Button_492fbb25d1014789ae6ee7bcf98318e4(eventobject) {
    showMenu();
}
function AS_Button_550fac7469fe497591b48ef3594b1645(eventobject) {
    showMenu();
}
...
function AS_Button_97117ba4b8844fb99731d7d97f94c519(eventobject) {
    showMenu();
}
...
function AS_Button_b3211cc780734657acf9349bb5955685(eventobject) {
    showMenu();
}
function AS_Button_be012084eafd446b9dd2b29ed116dfd1(eventobject) {
    showMenu();
}
